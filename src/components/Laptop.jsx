...
Command: npx gltfjsx@6.1.11 laptop.gltf --transform
  ...
  return (
    <group {...props} dispose={null} >
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <mesh geometry={nodes.Object_8.geometry} material={materials.Keyboard} />
        <mesh geometry={nodes.Object_9.geometry} material={materials.LabTop_Base} />
        <mesh geometry={nodes.Object_10.geometry} material={materials.LabTop_Base} />
        <mesh geometry={nodes.Object_11.geometry} material={materials.Mouse_PAD} />
      </group>
    </group>
  )
}
